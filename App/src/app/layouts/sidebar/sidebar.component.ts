...
import { adminMenuConst, userMenuConst } from 'src/app/core/constants/app-constants';
import { MenuItem } from 'src/app/core/models/menu.modal';
...
export class SidebarComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  initializeMenu()
  {
    if(this.loggedinUser.role === SystemRoleEnum.Librarian)
      this.menuItems = adminMenuConst;
    else
      this.menuItems = userMenuConst;
  }
